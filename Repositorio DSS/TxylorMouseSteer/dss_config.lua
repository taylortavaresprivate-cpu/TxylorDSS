...
cfg.CENTER_SPRING_ENABLED = false
cfg.CENTER_SPRING_GAIN   = 0.0
cfg.FFB_SMOOTH           = 0.0
cfg.SPEED_SENSI          = 1.0
...
function cfg.loadConfig()
	...
	cfg.CENTER_SPRING_ENABLED = getb("center_spring_enabled", cfg.CENTER_SPRING_ENABLED)
	cfg.CENTER_SPRING_GAIN   = clamp(getf("center_spring_gain", 0.0), 0.0, 10.0) * 0.3
	cfg.FFB_SMOOTH           = clamp(getf("ffb_smooth", 0.0), 0.0, 10.0) * 0.095
