...
function M.draw()
	u.header('ACELERADOR')
	u.cfgSlider('Pressionar', 'gas_press',   0.1, 10.0, '%.1f',
		'Velocidade ao pisar o acelerador. 10.0 = instantâneo.')
	u.cfgSlider('Soltar',     'gas_release', 0.1, 10.0, '%.1f',
	...
	u.header('FREIO')
	u.cfgSlider('Pressionar', 'brake_press',   0.1, 10.0, '%.1f',
		'Velocidade ao pisar o freio. 10.0 = instantâneo.')
	u.cfgSlider('Soltar',     'brake_release', 0.1, 10.0, '%.1f',
	...
	ui.offsetCursorY(2)
	u.cfgSlider('Pressionar', 'clutch_press',   0.1, 10.0, '%.1f',
		'Velocidade ao pisar a embreagem. 10.0 = instantâneo.')
	u.cfgSlider('Soltar',     'clutch_release', 0.1, 10.0, '%.1f',
	...
	u.hint('Tecla configurável na aba KEYBINDS.')
	ui.offsetCursorY(2)
	u.cfgSlider('Pressionar', 'handbrake_press',   0.1, 10.0, '%.1f',
		'Velocidade ao puxar o freio de mão. 10.0 = instantâneo.')
	u.cfgSlider('Soltar',     'handbrake_release', 0.1, 10.0, '%.1f',
